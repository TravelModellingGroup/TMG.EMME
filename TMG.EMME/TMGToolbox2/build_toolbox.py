...
def build_toolbox(toolbox_file, source_folder, title= 'TMG Toolbox', namespace= 'TMG2', consolidate= False):
    print "------------------------"
...
if __name__ == "__main__":
    ...
    if args.title == None: title = "TMG Toolbox 2"
    ...
    if args.namespace == None: namespace = 'tmg2'
