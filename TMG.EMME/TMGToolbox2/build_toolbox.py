...
if __name__ == "__main__":
    ...
    toolbox_title = "TMG Toolbox2" if args.title is None else args.title
    toolbox_fp = os.path.join(current_folder, 'TMG_Toolbox2.mtbx') if args.path is None else args.path
    toolbox_namespace = 'tmg2' if args.namespace is None else args.namespace
