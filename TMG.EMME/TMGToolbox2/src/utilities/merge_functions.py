...
class MergeFunctions(_m.Tool()):
    ...
    OPTIONS_LIST = [
        (EDIT_OPTION, "EDIT - Launch an editor GUI to resolve conflicts manually."),
    ...
    def page(self):
        ...
        pb.add_select_file(
            tool_attribute_name="function_file",
            window_type="file",
        ...
        pb.add_checkbox(tool_attribute_name="revert_on_error", label="Revert on error?")
