...
public class AssignTransit : BaseAction<ModellerController>
{
    ...
    [SubModule(Name = "Transit Classes", Description = "The classes for this multi-class assignment.", 
        Index = 36)]
    ...
    public class TransitClass : XTMF2.IModule
    {
        ...
        [SubModule(Name = "Walk Perceptions", Description = "Contains the walk perception values fo this multi-class assignment", 
            Index = 15, Required = false)]
    ...
    [Module(Name = "Walk Perceptions", Description = "Walk Perception",
